...
public class SendMailExample {
    ...
    public String main(String sendermail,String code)throws MessagingException {
        ...
        // Recipient's email ID needs to be mentioned.
            ...
            String sender_email = "deepthismouli123@gmail.com";//https://github.com/pakelcomedy/Send-OTP-Using-Java/blob/main/Testing/src/Main.java
            String sender_password = "mixomoudhkmvnzfq";
            ...
            Properties props = new Properties();//https://github.com/pakelcomedy/Send-OTP-Using-Java/blob/main/Testing/src/Main.java
             props.put("mail.smtp.user", sender_email);
             props.put("mail.smtp.host", sender_host);
             props.put("mail.smtp.port", sender_port);
             props.put("mail.smtp.starttls.enable","true");//https://gist.github.com/studyviral/7d7cfe861c3c2f0e6b731f5c235eb238
             ...
             MimeMessage msg = new MimeMessage(session); //https://www.codejava.net/coding/swing-application-for-sending-e-mail-with-attachments
...
{
    String sender_email = "deepthismouli123@gmail.com",
            sender_password = "mixomoudhkmvnzfq";
